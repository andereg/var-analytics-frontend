...
const StudyondLogo = () => (
    <svg viewBox="0 0 288 80" className="h-7 w-auto" preserveAspectRatio="xMinYMid meet">
        ...
        <g id="wordmark" opacity="1" className="fill-current">
            <path
                d="M0.759998 60.72V59.52H7.67V60.56C7.67 63.75 9.91 64.92 13.79 64.92H13.9C16.98 64.92 19.13 64.02 19.13 61.73V60.86C19.13 58.46 17.73 57.9 14.49 57.48L9.82 56.86C4.48 56.22 1.37 53.67 1.37 48.5V47.6C1.37 42.45 6.15 38.99 12.98 38.99H13.06C19.86 38.99 24.81 41.79 24.81 47.94V48.95H17.93V47.94C17.93 45.4 15.69 44.56 12.84 44.56H12.73C9.93 44.56 8.17 45.51 8.17 47.47V48.2C8.17 50.24 9.29 51.16 11.97 51.53L17 52.2C22.43 52.9 25.95 54.77 25.95 60.37V61.29C25.95 67.14 20.92 70.46 13.78 70.46H13.67C5.47 70.46 0.75 66.99 0.75 60.73L0.759998 60.72Z"/>
            <path
                d="M55.12 58.68V39.8H62.03V58.12C62.03 62.87 64.04 64.61 67.62 64.61H67.68C71.26 64.61 73.27 62.88 73.27 58.12V39.8H80.18V69.64H73.27V67.32C72.26 68.97 69.13 70.45 65.97 70.45H65.91C59.37 70.45 55.11 66.62 55.11 58.67L55.12 58.68Z"/>
            <path
                d="M97.34 70.43C90.77 70.43 86.52 66.6 86.52 58.65V50.76C86.52 42.82 90.77 38.98 97.34 38.98H97.4C101.18 38.98 103.69 40.46 104.67 42.11V28.81H111.58V69.64H104.67V67.29C103.69 68.94 101.17 70.42 97.4 70.42H97.34V70.43ZM99.1 64.58C102.65 64.58 104.67 62.87 104.67 58.12V51.3C104.67 46.54 102.66 44.81 99.1 44.81H99.04C95.46 44.81 93.45 46.54 93.45 51.3V58.12C93.45 62.87 95.46 64.58 99.04 64.58H99.1Z"/>
            <path
                d="M114.88 39.8H122.04L127.8 58.82H131.94L137.93 39.8H145.09L132.59 79.43H125.46L130.1 64.75H122.66L114.88 39.8Z"/>
            <path
            ...
            <path
                d="M179.13 39.8H186.07V42.12C187.05 40.47 190.21 38.99 193.34 38.99H193.4C199.94 38.99 204.19 42.82 204.19 50.77V69.65H197.28V51.33C197.28 46.57 195.27 44.84 191.69 44.84H191.63C188.08 44.84 186.06 46.57 186.06 51.33V69.65H179.12V39.81L179.13 39.8Z"/>
            <path
                d="M221.61 70.43C215.04 70.43 210.79 66.6 210.79 58.65V50.76C210.79 42.82 215.04 38.98 221.61 38.98H221.67C225.45 38.98 227.96 40.46 228.94 42.11V28.81H235.85V69.64H228.94V67.29C227.96 68.94 225.44 70.42 221.67 70.42H221.61V70.43ZM223.38 64.58C226.93 64.58 228.95 62.87 228.95 58.12V51.3C228.95 46.54 226.94 44.81 223.38 44.81H223.32C219.74 44.81 217.73 46.54 217.73 51.3V58.12C217.73 62.87 219.74 64.58 223.32 64.58H223.38Z"/>
            <path
                d="M53.07 45.71V39.81H41.69V32.76H34.75V39.81H29.02V45.71H34.75V63.11C34.75 67.95 36.15 69.65 41.63 69.65H47.2V63.75H44.37C42.28 63.75 41.69 63.39 41.69 61.04V45.71H53.07Z"/>
        </g>
    </svg>
);
...
const CollapsibleMenuItem: React.FC<CollapsibleMenuItemProps> = ({
    ...
    if (isCollapsed) {
        return (
            <Tooltip content={label} placement="right">
                <button
                    className="flex w-full items-center justify-center rounded-md p-2 text-sm transition-colors hover:bg-default-100">
                    <span className="flex-shrink-0">{icon}</span>
                </button>
            </Tooltip>
        );
...
const EmptyState: React.FC<{
    ...
    <div
        className="flex flex-col items-center justify-center gap-4 rounded-lg border-2 border-dashed border-default-200 p-12 text-center">
...
export default function Sidebar() {
    ...
    return (
            <aside
                className={`hidden h-full md:flex flex-col border-r border-default-200 bg-background transition-all duration-200 relative ${
                                ...
                                />
                                    <>
                                        <div className="flex-1 text-left min-w-0">
                                            <p className="font-medium truncate">Test user</p>
                                            <p className="text-xs text-default-500 truncate">test@test.com</p>
                                        </div>
                                    </>
                            </button>
                        </DropdownTrigger>
